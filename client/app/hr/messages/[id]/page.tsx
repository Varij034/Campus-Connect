...
export default function HRMessageThreadPage() {
  ...
  return (
    <ProtectedRoute requiredRole="hr">
      <div className="space-y-4 flex flex-col h-[calc(100vh-8rem)]">
        <Link href="/hr/messages" className="btn btn-ghost btn-sm gap-1 self-start">
        ...
        {conversation && (
          <div className="font-medium text-base-content/80">
            {conversation.candidate_name || `Candidate #${conversation.candidate_id}`}
